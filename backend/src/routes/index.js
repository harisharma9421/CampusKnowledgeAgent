  ...
  res.status(200).json({
    ...
    data: {
      ...
      availableRoutes: [
        ...
        'POST /api/v1/auth/login        - Login with PRN, roll number, employee ID, or email',
        ...
        'POST /api/v1/timetable         - Create timetable (faculty/admin)',
        'PUT  /api/v1/timetable/:id     - Update timetable (faculty/admin)',
        'GET  /api/v1/notices           - Notices',
        'POST /api/v1/notices           - Create notice (faculty/admin)',
        'PUT  /api/v1/notices/:id       - Update notice (faculty/admin)',
        'GET  /api/v1/events            - Events',
        'POST /api/v1/events            - Create event (faculty/admin)',
        'PUT  /api/v1/events/:id        - Update event (faculty/admin)',
        'GET  /api/v1/faculty           - Faculty',
        'GET  /api/v1/faq               - FAQ',
        'POST /api/v1/faq               - Create FAQ (faculty/admin)',
        'PUT  /api/v1/faq/:id           - Update FAQ (faculty/admin)',
